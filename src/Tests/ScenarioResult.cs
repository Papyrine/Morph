...
/// absolute error (fraction of pixels that differ at all; 0 = identical) computed by
/// <see cref="PageAbsoluteError"/>, and <paramref name="Ssim"/> is structural similarity
/// (1 = identical; null when the page sizes differ — see <see cref="PageSsim"/>). They fail
