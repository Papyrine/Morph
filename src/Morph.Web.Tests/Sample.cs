static class Sample
{
    // The bundled sample DOCX (an agenda/minutes document), copied next to the test assembly by the
    // csproj. Two pages, so it exercises the multi-page PNG (zip) path as well as the single-file formats.
