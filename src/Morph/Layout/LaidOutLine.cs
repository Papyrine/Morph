...
/// the fragmenter emits.
/// </summary>
readonly record struct LaidOutLine(float Width, float Height, float Ascent, IReadOnlyList<LaidOutRun> Runs, IReadOnlyList<LaidOutImage> Images);
