...
- ✅ FIXED | all | p1 | both corner staircase graphics now render at Word's exact positions and sizes (cell-anchored group, systemic #5).
...
- ✅ FIXED | all | p1 | the label sheet renders — navy cards, lavender/pink/yellow waves and white captions on all 6 labels (cell-anchored group hoisted + doc-parser group authority, systemic #5). Wave positions within the cards still differ somewhat from Word.
