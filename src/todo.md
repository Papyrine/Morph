...
- MINOR | all | p2 | section 3's mid-line run boxes (sz 18, space 1) stand taller than Word's: Word draws those small mid-line boxes INSIDE the font's line box with no reserve, while a whole-line, first, last or large mid-line box does reserve (`_probe_runbdr2` / `_probe_runbdr3`, docs/word-features.md Run Border) — the engine reserves in every case
