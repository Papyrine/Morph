...
- MAJOR | all | p1 | stray pink-bear fragment (ears/head outline) visible behind the upper-left of the first label's blue bear — extra image content not present in Word (the systemic-#5 group-extent clip covers shapes only; this is the IMAGE case — extend the clip to FloatingImageElement dest/source rects)
