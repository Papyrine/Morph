...
- MEDIUM | html | - | Table interior VERTICAL gridlines missing in the export (re-read 2026-08-20: the width:100%, header shading and h2 colour claims are stale — those all render)
