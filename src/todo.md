...
- MAJOR | all | p1 | stray pink-bear fragment (ears/head outline) visible behind the upper-left of the first label's blue bear — extra image content not present in Word. RECLASSIFIED: labels/16 has no pictures or shapes in document.xml — the bears are numbering PICTURE BULLETS (w:numPicBullet), so this is a picture-bullet source-crop/selection defect in the numbering subsystem, not floating art
