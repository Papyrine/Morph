...
- ✅ 2026-07-19 (−0.0014 per backend p2/p3): the orange square outline renders at the top-right page edge (outline-only emission, rect preset)
- MAJOR | all | p1,p2,p3 | teal triangle outline at left margin missing — the outline-only emission guards out presets without built contours; needs a `PresetShapeGeometry` triangle builder to land
