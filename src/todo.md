...
- MEDIUM | all | p2 | Right-column "Adding your own message" section starts a paragraph (~100px) higher than Word: its first "Add a simple greeting…" paragraph sits above where Word's does, so the column shows two of Word's three paragraphs below the photo (the photo box and caption themselves now sit within 4px of Word's; measured 2026-09-06 after the frames and effect extents landed)
...
- MEDIUM | all | p4 | Left column: the big photo block starts ~43px higher than Word and the lines under it 30-50px higher (Morph 22 bands to Word's 27 — a caption/heading pair merges); right column: "Write with ease using Editor" heading and body ~30px (one line) higher
